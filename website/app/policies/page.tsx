...
export default function PoliciesAndBoundariesPage() {
  return (
    <>
      <section className="policy-hero">
        <div className="container content-container">
          <h1>Policies &amp; Boundaries</h1>
          <p className="hero-subtitle">
            Clear agreements create safety. These policies outline how we hold space together
            so you can explore freely within a well-defined container.
          </p>
        </div>
      </section>
      ...
      <section className="policy-content">
        <div className="container content-container">
          ...
          <div className="policy-section">
            <h2>Questions?</h2>
            <p>
              If you have any questions about these policies, please reach out before booking:
            </p>
            <p>
              <strong>Email:</strong>{' '}
